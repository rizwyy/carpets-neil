<template>
  <div class="h-full w-screen overflow-hidden font-outfit">
    ...
    <!--INPUT ERROR OVERLAY -->
    <div
      class="iptErrMsg_GYM opacity-0 invisible h-max py-[2.4vh] px-[2vw] left-[50%] translate-x-[-50%] top-[2.4vh] rounded-md w-[72vw] flex justify-center items-center fixed gap-[2vw] bottom-0 bg-[#000] bg-opacity-[.3] backdrop-blur-[8px] z-[999]"
    >
