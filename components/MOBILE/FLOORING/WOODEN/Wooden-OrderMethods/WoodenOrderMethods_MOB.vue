<template>
  <transition @beforeEnter="handleDetailsDOMEntry('woodenOrderMethods_MOB')">
    <div
      v-show="
    ...
    >
      ...
      >
        <span
          class="w-[75%] px-[4vw] text-[3.2vh] leading-[3.8vh] woodenOrderMethods_MOB-HEADING opacity-0 translate-x-[40%] text-detailsHeadCLR"
        ...
        >
          <button
            ...
            v-show="
              ...
              userStore.preference.budget !== ''
            "
            class="w-[44vw] woodenOrderMethods_MOB-CONTAINER opacity-0 translate-y-[20%] rounded-md text-[2.4vh] font-[500] bg-[#111] border-[2px] border-[#333] z-[999] text-white px-[2vw] flex items-center gap-[2vw] justify-between"
          >
            <!-- MOBILE -->
            <span
          ...
          <button
            ...
            v-show="
              ...
              userStore.preference.budget !== ''
            "
            class="w-[44vw] woodenOrderMethods_MOB-CONTAINER opacity-0 translate-y-[20%] rounded-md tracking-[.3vw] text-[2.4vh] font-[500] bg-[#111] border-[2px] border-[#333] z-[999] text-white px-[2vw] flex items-center gap-[2vw] justify-between"
          >
            <div
