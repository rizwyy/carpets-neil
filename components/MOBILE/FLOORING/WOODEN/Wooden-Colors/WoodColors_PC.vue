  ...
  <div class="max-[990px]:hidden h-max w-screen px-[6vw]">
    ...
    >
      <div
        ...
        "
        class="container relative h-max w-full shadow-xl py-[4vh] px-[4vw] bg-[#f1f1f1] bg-opacity-60 rounded-md shadow-lg text-center flex flex-col gap-[8vh]"
      >
            ...
            <div class="h-max w-max flex gap-[4vw]">
              ...
              >
                <button
                  ...
                  class="wooden_details_colors_mob_add_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                >
                  Add More
                </button>
              </transition>
        ...
        >
          ...
          <div class="color-selection flex justify-between gap-[2.4vw] z-[9]">
            ...
            >
              <span
                class="text-[2.8vh]"
                v-show="!selectedColors.includes('Grey')"
                >Grey</span
              >
              <NuxtImg
                v-show="userStore.preference.spec_2 !== 'Cork Floor'"
