<template>
  <transition
    @before-enter="handleDetailsDOMEntry('wooden_Budget_Details_Mob')"
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              'h-[10vh]  wooden_Budget_Details_Mob-CONTAINER  w-[100%] shadow border-[2px] border-[#000] overflow-hidden items-center justify-between flex text-[#f1f1f1] px-[4.8vw] py-[1.2vh] text-[2.4vh] relative cursor-pointer',
