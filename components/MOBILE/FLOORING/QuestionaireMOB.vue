<template>
  <div
    ...
    class="h-[68rem] w-screen max-w-[100vw] fixed top-0 left-0 flex flex-col pt-[4.2rem] justify-start items-center bg-[#000] bg-opacity-[.3] backdrop-blur-[8px] z-[999999] font-outfit"
  >
    <div
