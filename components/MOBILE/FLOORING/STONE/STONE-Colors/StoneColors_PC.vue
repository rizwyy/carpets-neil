<template>
  ...
  >
      ...
      >
        ...
        >
          <span
            ...
            class="text-left text-balance stone_Colors_Details_PC-HEADING opacity-0 translate-x-[40%] text-detailsContainer_heading_PC"
          >
          ...
          <button
            ...
            class="h-max bg-white text-gray-500 px-[2vw] py-[1vh] text-[2.8vh] rounded-md flex gap-[.4vw] items-center"
          >
            <!-- DESKTOP -->
            <span class="text-[2.2vh]">Clear All</span><ClearAllIcon />
          </button>
        </div>
        ...
        >
          ...
          >
            ...
            >
              <span class="text-[#f1f1f1] text-[2vw] font-[400]"
            ...
            >
              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                <transition
                  @beforeEnter="
                    bringOpacity('stone_details_colors_mob_add_BTN')
                  "
                  @beforeLeave="
                    removeOpacity('stone_details_colors_mob_add_BTN')
                  "
                >
                  <button
                    v-show="customColor.length > 2"
                    @click="toggleSelect(customColor, 'addMore')"
                    class="stone_details_colors_mob_add_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                <transition
                  @beforeEnter="
                    bringOpacity('stone_details_colors_mob_done1_BTN')
                  "
                >
                  <button
                    v-show="
                    ...
                    class="stone_details_colors_mob_done1_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
                <button
                  ...
                  @click="toggleSelect('done')"
                  class="stone_details_colors_mob_done_BTN text-[2vh] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1.8vh]"
                >
                  Done
                </button>
              </div>
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gradient-to-br from-[#f44369] via-[#f4985a] to-[#b9dfee] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!-- DESKTOP -->
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#333] bg-[#F5F5DC] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!-- DESKTOP -->
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-[brown] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!--  -->
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gray-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <!--  -->
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-orange-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            <div
              ...
              class="color_box_PC h-[18vh] bg-[gold] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-green-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <div
              v-show="userStore.preference.spec_3 !== 'Sisal'"
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-green-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-blue-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-black rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <div
              v-show="userStore.preference.spec_3 === 'Sisal'"
              class="color_box_PC h-[18vh] bg-[tan] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-tan-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <div
              v-show="userStore.preference.spec_3 !== 'Sisal'"
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-red-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <div
              class="color_box_PC h-[18vh] stone_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#444] bg-white rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
    ...
    <!-- METALLIC -->
    <transition
      @beforeEnter="handleDetailsDOMEntry('stone_Metallic_Colors_Details_PC')"
    >
      <div
        v-show="
          userStore.preference.spec_1 !== '' &&
      ...
      >
        ...
        >
          <span
            v-show="!isMultiColoredOpted"
            class="text-left text-balance stone_Metallic_Colors_Details_PC-HEADING opacity-0 translate-x-[40%] text-detailsContainer_heading_PC"
          >
            Choose Your Color
          </span>
          <button
        ...
        >
          <div class="color-selection grid grid-cols-3 gap-[2.8vw] z-[9]">
            ...
            <div
              ...
              :key="color.name"
              class="color_box_PC h-[18vh] overflow-hidden stone_Metallic_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-start text-white rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
    ...
    <!-- FLAKES -->
    <transition
      @beforeEnter="handleDetailsDOMEntry('stone_Flakes_Colors_Details_PC')"
    >
      <div
      ...
      >
        ...
        >
          <span
            v-show="!isMultiColoredOpted"
            class="text-left text-balance stone_Flakes_Colors_Details_PC-HEADING opacity-0 translate-x-[40%] text-detailsContainer_heading_PC"
          >
            Choose Your Color
          </span>
          <button
        ...
        >
          <div class="color-selection grid grid-cols-4 gap-[2.8vw] z-[9]">
            ...
            <div
              ...
              :key="flake.name"
              class="color_box_PC h-[18vh] stone_Flakes_Colors_Details_PC-CONTAINER overflow-hidden opacity-0 translate-y-[20%] w-full flex items-center justify-start text-white rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
    ...
    <div class="h-max w-full flex items-center justify-center">
      ...
      >
        ...
        >
          <span
            class="text-[3.8vw] bg-gradient-to-r from-[#fff] to-blue-300 bg-clip-text text-transparent font-outfit font-[300]"
        ...
        >
          <div class="h-max w-max flex gap-[4vw] pt-[2vh]">
            <button
              ...
              @click="toggleSelect(customColor, 'addMore')"
              class="stone_details_colors_mob_add_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh] disabled:cursor-not-allowed disabled:text-[#999] disabled:hover:text-[#666] disabled:hover:border-[#666]"
            >
              Add
            </button>
          </div>
...
const metallicColors = [
  { name: "Coffee", image: "/stone/metallic/coffeestone.webp" },
  { name: "Copper", image: "/stone/metallic/copperstone.webp" },
  { name: "Grey", image: "/stone/metallic/greystone.webp" },
  { name: "Concrete", image: "/stone/metallic/concretestone.webp" },
  { name: "Blue Jay", image: "/stone/metallic/blueJaystone.webp" },
  { name: "Black", image: "/stone/metallic/blackstone.webp" },
  { name: "Caramel", image: "/stone/metallic/caramelstone.webp" },
  { name: "Clear", image: "/stone/metallic/clearstone.webp" },
];

const flakeColors = [
  { name: "Fire", image: "/stone/flakes/customFirestone.webp" },
  { name: "Blue", image: "/stone/flakes/customBluestone.webp" },
  { name: "Grey", image: "/stone/flakes/customGreystone.webp" },
  { name: "Sand", image: "/stone/flakes/customSandstone.webp" },
  { name: "Timber", image: "/stone/flakes/customTimberstone.webp" },
  { name: "Viper", image: "/stone/flakes/customViperstone.webp" },
  { name: "Black", image: "/stone/flakes/customBlackstone.webp" },
];
...
.selected {
  ...
  border: 4px solid #333; /* Example border color */
}
