          ...
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            ...
            <div
              :class="[
                ...
                { selected: spec_3.includes('Granite') },
              ]"
              @click="toggleSelect('Granite')"
            >
              <div
                v-show="spec_3.includes('Granite')"
          ...
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            ...
            >
              ...
              <NuxtImg
                ...
                loading="eager"
                class="h-full w-full object-cover absolute left-0 bottom-0 z-[-9]"
                src="/stone/stoneSolid.webp"
                alt=""
              />
              <span class="text-[3.4vh]">Solid</span>
            </div>
            <div
              :class="[
                'h-[28vh] overflow-hidden stone_Type_Details_PC-CONTAINER opacity-0  w-full rounded-md  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
            ...
            >
              ...
              <NuxtImg
                ...
                loading="eager"
                class="h-full w-full object-cover absolute left-0 bottom-0 z-[-9]"
                src="/stone/stoneStone.webp"
                alt=""
              />
              <span class="text-[3.4vh]">Stone</span>
            </div>
          </div>
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            <div
            ...
            >
              ...
              <NuxtImg
                ...
                loading="eager"
                class="h-full w-full object-cover absolute left-0 bottom-0 z-[-9]"
                src="/stone/stoneWood.webp"
                alt=""
              />
              <span class="text-[3.4vh]">Wood</span>
            </div>
            <div
              :class="[
                'h-[28vh] overflow-hidden stone_Type_Details_PC-CONTAINER opacity-0  w-full rounded-md  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
            ...
            >
              ...
              <NuxtImg
                ...
                loading="eager"
                class="h-full w-full object-cover absolute left-0 bottom-0 z-[-9]"
                src="/Custom/Custom/CustomFlooring.webp"
                alt=""
              />
              <span class="text-[3.4vh]">Custom</span>
            </div>
          </div>
        </div>
      </div>
