  ...
  <div class="max-[990px]:hidden h-max w-screen px-[6vw]">
    <transition @before-enter="handleDetailsDOMEntry('pvc_colors_Details_PC')">
      <div
        ...
        "
        class="container relative h-max w-full py-[6vh] px-[4vw] bg-[#f1f1f1] bg-opacity-60 rounded-t-md text-center flex flex-col gap-[8vh]"
      >
        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                <transition
                  @beforeEnter="bringOpacity('pvc_details_colors_mob_add_BTN')"
                  @beforeLeave="removeOpacity('pvc_details_colors_mob_add_BTN')"
                >
                  <button
                    v-show="customColor.length > 2"
                    @click="toggleSelect(customColor, 'addMore')"
                    class="pvc_details_colors_mob_add_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                <transition
                  @beforeEnter="
                    bringOpacity('pvc_details_colors_mob_done1_BTN')
                  "
                >
                  <button
                    v-show="
                    ...
                    class="pvc_details_colors_mob_done1_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
                <button
                  ...
                  @click="toggleSelect('done')"
                  class="pvc_details_colors_mob_done_BTN text-[2vh] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1.8vh]"
                >
                  Done
                </button>
              </div>
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gradient-to-br from-[#f44369] via-[#f4985a] to-[#b9dfee] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!-- DESKTOP -->
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#333] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!-- DESKTOP -->
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-[brown] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!--  -->
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gray-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <!--  -->
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-orange-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-green-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-blue-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-black rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-pink-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <div
              class="color_box_PC h-[18vh] pvc_colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#000] bg-white rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
...
const toggleSelect = (color, added) => {
  console.log(toRaw(customColor.value));
  if (color === "done") {
