  ...
  <transition @beforeEnter="handleDetailsDOMEntry('pvcRevForm')">
    ...
    >
      ...
      >
        ...
        <button
          @click="handleClick"
          class="bg-[#fff9] text-center pvcRevForm-HEADING active:scale-[.93] backdrop-blur-[8px] w-full border-[3.2px] tracking-[.2vw] border-[#333] rounded-md py-[2.4vh] uppercase font-[400] text-[2.4vh] px-[2vw] outline-none focus:border-black"
        >
          CONFIRM
        </button>
      </div>
