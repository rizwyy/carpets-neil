        ...
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          ...
          >
            ...
            <NuxtImg
              ...
              alt="Metallic Epoxy Flooring by Woltiz"
            />
            <span class="text-left text-balance">Metallic</span>
          </div>
        </div>
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          <div
          ...
          >
            ...
            <NuxtImg
              ...
              alt=""
            />
            <span class="text-left text-balance">Flakes</span>
          </div>
          ...
          >
            ...
            <NuxtImg
              ...
              alt=""
            />
            <span class="text-left text-balance">Printed</span>
          </div>
        </div>
      </div>
    </div>
