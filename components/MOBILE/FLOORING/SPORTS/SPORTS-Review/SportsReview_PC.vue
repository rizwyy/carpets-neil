    ...
    >
      ...
      >
        ...
        <div class="h-max w-full flex flex-col items-start gap-[1.2vh]">
          <span
            class="text-detailsContainer_heading_PC sportsRevForm-HEADING translate-y-[20%] opacity-0 w-full text-start tracking-[-.1vw] font-[400] text-[3.8vh] text-[#333]"
        ...
        <button
          @click="handleClick"
          class="bg-[#fff9] text-center sportsRevForm-HEADING active:scale-[.93] backdrop-blur-[8px] w-full border-[3.2px] tracking-[.2vw] border-[#333] rounded-md py-[2.4vh] uppercase font-[400] text-[2.4vh] px-[2vw] outline-none focus:border-black"
        >
          CONFIRM
        </button>
      </div>
