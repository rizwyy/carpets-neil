    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              'h-[5.2rem] sport_Budget_Details_Mob-CONTAINER overflow-hidden opacity-0 translate-y-[20%] w-[100%] shadow border-[2px] border-[#f1f1f1] overflow-hidden  rounded-full  items-center justify-between flex text-[#f1f1f1] px-[4.8vw] py-[1.2vh] text-[1.2rem] relative cursor-pointer',
