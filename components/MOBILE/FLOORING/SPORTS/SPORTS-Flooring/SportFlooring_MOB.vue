          ...
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            ...
            <div
              :class="[
                ...
                { selected: spec_3.includes('Artificial Grass') },
              ]"
              @click="toggleSelect('Artificial Grass')"
            >
              <div
                v-show="spec_3.includes('Artificial Grass')"
            ...
            <div
              :class="[
                'h-[14vh] w-full rounded-md text-left leading-[3.4vh]  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[4.6vw] relative cursor-pointer',
                { selected: spec_3.includes('Rubber') },
              ]"
              @click="toggleSelect('Rubber')"
            >
              <div
                v-show="spec_3.includes('Rubber')"
                class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
              >
                <!-- Selected indicator without text -->
                <span
          ...
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            ...
            <div
              :class="[
                ...
                { selected: spec_3.includes('Wooden Sprung') },
              ]"
              @click="toggleSelect('Wooden Sprung')"
            >
              <div
                v-show="spec_3.includes('Wooden Sprung')"
                class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
              >
                <!-- Selected indicator without text -->
                <span
            ...
            <div
              :class="[
                ...
                { selected: spec_3.includes('PolyUrethane') },
              ]"
              @click="toggleSelect('PolyUrethane')"
            >
              <div
                v-show="spec_3.includes('PolyUrethane')"
                class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
              >
                <!-- Selected indicator without text -->
                <span
        ...
        <div class="h-max w-[40vw] flex flex-col gap-[1vh]">
          ...
          >
            ...
            <div
              :class="[
                'h-[14vh] w-full rounded-md  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[4.6vw]  relative cursor-pointer',
                { selected: spec_3.includes('PVC Sports') },
              ]"
              @click="toggleSelect('PVC Sports')"
            >
              <div
                v-show="spec_3.includes('PVC Sports')"
                class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
              >
                <!-- Selected indicator without text -->
                <span
            ...
            <div
              :class="[
                'h-[14vh] w-full rounded-md text-left leading-[3.4vh]  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[4.6vw] relative cursor-pointer',
                { selected: spec_3.includes('Acrylic Sports') },
              ]"
              @click="toggleSelect('Acrylic Sports')"
            >
              <div
                v-show="spec_3.includes('Acrylic Sports')"
                class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
              >
                <!-- Selected indicator without text -->
                <span
