<template>
  ...
  >
    ...
    >
      <div
        class="h-full w-full absolute top-0 left-0 bg-gradient-to-t from-[#b5c6e0] via-[#103783] z-[-9]"
      ></div>
      ...
      <div class="h-max w-full flex flex-col items-center gap-[8vh]">
        <div class="h-max w-full flex flex-col items-center gap-[5vh]">
          ...
          <select
            ...
            class="w-full bg-inherit rounded-lg border-[2px] border-[#fff9] px-[3.2vw] py-[2.4vh] text-[2.4vh]"
          >
        ...
        <button
          ...
          class="rounded-md border-[2px] text-[2.4vh] font-[500] tracking-[.2vw] text-[#f1f1f1] bg-[#000] bg-opacity-[.6] border-[#fff9] py-[2.4vh] w-[100%]"
        >
          PROCEED
        </button>
      </div>
