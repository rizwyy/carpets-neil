<template>
  <div class="h-max w-screen overflow-hidden font-outfit mb-[14vh]">
    <!-- ERROR OVERLAY -->
    <div
    ...
    >
      <div
        class="h-max w-full flex flex-col gap-[5.8vh] overflow-hidden px-[3.8vw] pt-[3.2vh] rounded-md shadow-xl relative"
      >
        <NuxtImg
        ...
        <div class="h-max w-full flex flex-col gap-[12.2vh] pb-[3.2vh]">
          <input
          ...
          <button
            ...
            class="bg-white checkout_Text active:scale-[.93] opacity-0 w-[88vw] border-[2.4px] tracking-[.2vw] border-[#333] rounded-md py-[2.4vh] uppercase font-[400] text-[2.4vh] px-[2vw] outline-none focus:border-black"
          >
            PROCEED
          </button>
        </div>
