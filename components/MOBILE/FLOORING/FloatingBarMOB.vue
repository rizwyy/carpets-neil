  ...
  >
    ...
    >
      <a
        ...
        class="font-[500] text-[2.2vh] tracking-[.1vw] flex items-center gap-[1vw] justify-center bg-gradient-to-r from-[#fff9] via-[#E0FFFF] to-[#fff9] bg-clip-text text-transparent animate-gradient"
      >
