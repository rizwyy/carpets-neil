<template>
  <transition @beforeEnter="handleDetailsDOMEntry('carpetOrderMethods_MOB')">
    <div
      v-show="
    ...
    >
      ...
      >
        <span
          class="w-[75%] px-[4vw] text-[3.2vh] leading-[3.8vh] carpetOrderMethods_MOB-HEADING opacity-0 translate-x-[40%] text-detailsHeadCLR"
