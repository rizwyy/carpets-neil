<template>
  ...
  <transition>
    <div
      class="min-[990px]:hidden carpets_Category_Details_Mob h-max w-[96vw] text-center py-[4vh] flex flex-col gap-[1vh] font-outfit font-[400] bg-[#ececec] rounded-md shadow-lg bg-opacity-[.6] px-[3vw]"
    >
      <div
