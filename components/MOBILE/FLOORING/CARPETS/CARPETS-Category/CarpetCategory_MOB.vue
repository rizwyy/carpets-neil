<template>
  ...
  <transition>
    <div class="h-max w-screen flex justify-center pb-[10vh]">
      <div
        class="min-[990px]:hidden carpets_Category_Details_Mob h-max w-[96vw] text-center py-[4vh] flex flex-col gap-[1vh] font-outfit font-[400] bg-gradient-to-br from-detailsFrom to-detailsTo rounded-md shadow-lg bg-opacity-[.6] px-[3vw]"
      >
        <div
