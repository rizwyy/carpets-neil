    ...
    >
      ...
      >
        ...
        <button
          ...
          class="h-max w-max bg-white text-gray-500 px-[2vw] py-[1.2vh] text-[2.8vh] rounded-md flex gap-[.4vw] items-center"
        >
...
const toggleSelect = (category) => {
  if (spec_1.value === category) {
    ...
    scrollToEl("carpetTypesContainerPC");
