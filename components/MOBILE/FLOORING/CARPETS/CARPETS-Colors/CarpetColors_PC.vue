      ...
      >
        ...
        >
          <span
            ...
            class="text-left text-balance carpets_Colors_Details_PC-HEADING opacity-0 translate-x-[40%] text-detailsContainer_heading_PC"
          >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                <transition
                  @beforeEnter="
                    bringOpacity('carpet_details_colors_mob_add_BTN')
                  "
                  @beforeLeave="
                ...
                >
                  <button
                    ...
                    class="carpet_details_colors_mob_add_BTN text-[1.4vw] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gradient-to-br from-[#f44369] via-[#f4985a] to-[#b9dfee] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!-- DESKTOP -->
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#333] bg-[#F5F5DC] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!-- DESKTOP -->
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-[brown] rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <!--  -->
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gray-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <!--  -->
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-orange-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            ...
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-blue-500 rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
            ...
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-black rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
            ...
            <div
              class="color_box_PC h-[18vh] carpets_Colors_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#444] bg-white rounded-md cursor-pointer relative px-[1.6vw] py-[.8vh]"
              :class="{
