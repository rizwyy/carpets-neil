  ...
  <div class="max-[990px]:hidden h-max w-screen px-[6vw]">
    ...
    >
      ...
      >
        ...
        >
          <span
            class="raised_Budget_Details_pc-HEADING opacity-0 translate-x-[40%] text-detailsContainer_heading_PC"
        ...
        >
          ...
          <div
            :class="[
              'h-[12vh] raised_Budget_Details_pc-CONTAINER opacity-0 translate-y-[20%] budgetItemPC w-[60%] shadow border-[2px] border-[#f1f1f1] overflow-hidden  rounded-full  items-center justify-between flex text-[#f1f1f1] px-[4.8vw] py-[1.2vh] text-[2.4vh] relative cursor-pointer',
