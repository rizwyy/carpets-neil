    ...
    >
      ...
      >
        ...
        <div class="h-max w-full flex justify-between text-[3.8vh] z-[9]">
          <span
            class="text-left text-balance raised_Finishes_Details_PC-HEADING opacity-0 text-detailsContainer_heading_PC translate-x-[40%]"
        ...
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          ...
          <div
            :class="[
              'materialItem_PC rounded-md h-[28vh] raised_Finishes_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
          ...
          >
            ...
            ></div>
            <NuxtImg
              v-show="userStore.preference.spec_3 === 'HPL'"
              quality="50"
              placeholder
              loading="lazy"
              class="h-full w-full object-cover absolute left-0 bottom-0 z-[-9]"
              src="/raised/HPL-finish1.webp"
              alt="#"
            />
            <NuxtImg
              v-show="userStore.preference.spec_3 === 'PVC'"
              quality="50"
              placeholder
              loading="lazy"
              class="h-full w-full object-cover absolute left-0 bottom-0 z-[-9]"
              src="/raised/PVC-finish1.webp"
              alt="#"
            />
        ...
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          ...
          <div
            :class="[
              'materialItem_PC rounded-md h-[28vh] raised_Finishes_Details_PC-CONTAINER opacity-0 translate-y-[20%] w-full  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.2vw] py-[1.4vh] text-[2.4vh] relative cursor-pointer',
              { selected: userStore.preference.spec_4 === 'Finish 5' },
            ]"
            @click="toggleSelect('Finish 5')"
          >
            <div
              v-show="userStore.preference.spec_4 === 'Finish 5'"
              class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
            >
              <!-- Selected indicator without text -->
              <span
        ...
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          ...
          >
            <div
              v-show="userStore.preference.spec_4 === 'Finish 7'"
              class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
            >
              <!-- Selected indicator without text -->
              <span
