    ...
    >
      ...
      >
        ...
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          ...
          <div
            :class="[
              'materialItem_PC rounded-md h-[28vh] raised_Panel_Details_pc-CONTAINER opacity-0 translate-y-[20%] w-full  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
              { selected: selectedThickness === 'Bare' },
            ]"
            @click="toggleSelect('Bare')"
          >
            <div
              v-show="selectedThickness === 'Bare'"
            ...
            <NuxtImg
              ...
              alt="#"
            />
            <span class="text-[3.2vh]">Bare</span>
          </div>
          <!-- HPL -->
          <div
            :class="[
              'materialItem_PC rounded-md h-[28vh] raised_Panel_Details_pc-CONTAINER opacity-0 translate-y-[20%] w-full  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
              { selected: selectedThickness === 'HPL' },
            ]"
            @click="toggleSelect('HPL')"
          >
            <div
              v-show="selectedThickness === 'HPL'"
              class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
            >
              <!-- DESKTOP -->
              <!-- Selected indicator without text -->
            ...
            <NuxtImg
              ...
              alt="#"
            />
            <span class="text-[3.2vh]">HPL</span>
          </div>
          <!-- DESKTOP -->
        </div>
        <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
          ...
          <div
            :class="[
              'materialItem_PC rounded-md h-[28vh] raised_Panel_Details_pc-CONTAINER opacity-0 translate-y-[20%] w-full  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
              { selected: selectedThickness === 'PVC' },
            ]"
            @click="toggleSelect('PVC')"
          >
            <div
              v-show="selectedThickness === 'PVC'"
              class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
            >
              <!-- Selected indicator without text -->
              <span
          ...
          <div
            :class="[
              'materialItem_PC rounded-md h-[28vh] raised_Panel_Details_pc-CONTAINER opacity-0 translate-y-[20%] w-full  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
              { selected: selectedThickness === 'Perforated' },
            ]"
            @click="toggleSelect('Perforated')"
          >
            <div
              v-show="selectedThickness === 'Perforated'"
              class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
            >
              <!-- DESKTOP -->
              <!-- Selected indicator without text -->
            ...
            <NuxtImg
              ...
              alt="#"
            />
            <span class="text-[3.2vh]">Perforated</span>
          </div>
          <!-- DESKTOP -->
        </div>
      </div>
