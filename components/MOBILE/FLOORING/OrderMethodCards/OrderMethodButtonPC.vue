<template>
  <button
    ...
    class="relative w-[30%] h-[12vh] rounded-lg text-[2.2vh] font-medium border-[2.8px] border-[#333] z-[999] text-white px-[4vw] flex items-center justify-between shadow-xl transition-all duration-300 ease-in-out"
    aria-label="button"
  >
