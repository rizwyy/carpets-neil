<template>
  <button
    ...
    class="relative w-[30%] h-[14vh] rounded-lg text-[2.2vh] font-medium border-[2.8px] border-[#333] z-[999] text-white px-[4vw] flex items-center justify-between shadow-xl transition-all duration-300 ease-in-out"
    aria-label="button"
  >
    ...
    >
      <span
        ...
        class="font-semibold text-[3.2vh]"
      >
        <TickCircleIcon />
      </span>
    </div>
    ...
    <div class="flex items-center gap-[2vw] w-full">
      <!-- Icon Section -->
      <div
        class="text-[5vh] flex-shrink-0 flex items-center justify-center"
      ...
      <div
        ...
        class="flex-1 text-start font-[500] text-[2.8vh]"
