<template>
  ...
  <div class="max-[990px]:hidden h-max w-screen px-[6vw]">
    <transition @beforeEnter="handleDetailsDOMEntry('gym_Budgets_Details_PC')">
      <div
        id="gymBudgetsContainerPC"
        v-show="
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              'h-[12vh] gym_Budgets_Details_PC-CONTAINER opacity-0 translate-y-[20%] budgetItemPC w-[60%] shadow border-[2px] border-[#f1f1f1] overflow-hidden  rounded-full  items-center justify-between flex text-[#f1f1f1] px-[4.8vw] py-[1.2vh] text-[2.4vh] relative cursor-pointer',
