<template>
  <!--INPUT ERROR OVERLAY -->
  <transition @beforeEnter="handleDetailsDOMEntry('GymInfoMOB')">
    <div
      v-show="
      ...
      <div class="h-max w-screen pt-[2vh] pb-[6vh] flex justify-center">
        ...
        >
          <div class="h-max w-max flex flex-col gap-[.4vh] items-start">
            <span
              class="GymInfoMOB-HEADING opacity-0 translate-y-[20%] w-max text-[3.8vh] tracking-[-.2vw] font-[400] text-[#444]"
              >Your Contact Information</span
            >
            <span
              class="GymInfoMOB-HEADING opacity-0 translate-y-[20%] text-[#999] text-[2.2vh] font-[450]"
              >Enter your contact information</span
            >
          </div>

          <div
            class="invisible opacity-0 GymInfoMOB-CONTAINER h-full w-full absolute top-0 left-0 flex items-center justify-center bg-[#fff1] backdrop-blur-[8px] z-[1]"
          >
            <svg
          ...
          <div class="h-max w-full flex flex-col gap-[vh]">
            <input
              type="text"
              class="border-[2px] GymInfoMOB-CONTAINER opacity-0 translate-y-[20%] rounded-md px-[2.4vw] border-[#555] bg-[#fff9] py-[1.8vh] outline-none focus:border-black"
              placeholder="Name"
              v-model="nameIpt"
            />
          </div>
          ...
          <div class="h-max w-full flex flex-col gap-[6.2vh] pb-[6.2vh]">
            <div class="h-max w-full flex">
              <select
                ...
                class="w-max rounded-l-md border-[2px] border-r-[0px] border-[#555] bg-[#fff9] py-[1.4vh] px-[.8vw] text-[2vh] outline-none GymInfoMOB-CONTAINER opacity-0"
              >
              ...
              <input
                ...
                type="number"
                class="[appearance:textfield] w-full [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none border-[2px] text-[2vh] GymInfoMOB-CONTAINER opacity-0 translate-y-[20%] rounded-r-md px-[2.4vw] border-[#555] border-l-[#777] bg-[#fff9] py-[1.8vh] outline-none focus:border-black"
                placeholder="Phone"
                v-model="phoneIpt"
              />
            </div>
            <button
              ...
              class="bg-white GymInfoMOB-CONTAINER active:scale-[.93] opacity-0 w-[88vw] border-[2.4px] tracking-[.2vw] border-[#333] rounded-md py-[2.4vh] uppercase font-[400] text-[2.4vh] px-[2vw] outline-none focus:border-black"
            >
              SUBMIT
            </button>
          </div>
