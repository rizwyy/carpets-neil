<template>
  <!--INPUT ERROR OVERLAY -->
  <transition @beforeEnter="handleDetailsDOMEntry('gymInfoPC')">
    <div
      v-show="
    ...
    >
      <div
        class="iptErrMsg_gym opacity-0 invisible h-max py-[2.4vh] px-[2vw] left-[50%] translate-x-[-50%] top-[2.4vh] rounded-md w-[72vw] flex justify-center items-center fixed gap-[2vw] bottom-0 bg-[#000] bg-opacity-[.7] backdrop-blur-[8px] z-[999]"
      >
        <span
          class="text-white text-detailsContainer_heading_PC font-[500] tracking-[.2vw] uppercase text-center"
        ...
        >
          ...
          >
            <div class="h-max w-max flex flex-col gap-[.4vh] items-start">
              <span
                class="gymInfoPC-HEADING opacity-0 translate-y-[20%] w-max text-[2.4vw] font-[400] text-[#444]"
                >Your Contact Information</span
              >
              <span
                class="gymInfoPC-HEADING opacity-0 translate-y-[20%] text-[#999] text-[1.4vw] font-[450]"
                >Enter your contact information</span
              >
            </div>

            <div
              class="invisible opacity-0 gymInfoPC-CONTAINER h-full w-full absolute top-0 left-0 flex items-center justify-center bg-[#fff1] backdrop-blur-[8px] z-[1]"
            >
              <svg
            ...
            <div class="h-max w-full flex flex-col gap-[vh]">
              <input
                type="text"
                class="border-[2px] gymInfoPC-CONTAINER opacity-0 translate-y-[20%] rounded-md px-[1.2vw] border-[#555] bg-[#fff9] py-[2.4vh] outline-none focus:border-black"
                placeholder="Name"
                v-model="nameIpt"
              />
            </div>
            ...
            <div class="h-max w-full flex flex-col gap-[6.2vh] pb-[6.2vh]">
              <div class="h-max w-full flex">
                <select
                  ...
                  class="w-max rounded-l-md border-[2px] border-r-[0px] border-[#555] bg-[#fff9] py-[1.4vh] px-[.8vw] text-[2vh] outline-none gymInfoPC-CONTAINER opacity-0"
                >
                ...
                <input
                  ...
                  type="number"
                  class="[appearance:textfield] w-full [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none border-[2px] gymInfoPC-CONTAINER opacity-0 translate-y-[20%] rounded-r-md px-[1.2vw] border-[#555] border-l-[#777] bg-[#fff9] py-[2.4vh] text-[2vh] outline-none focus:border-black"
                  placeholder="Phone"
                  v-model="phoneIpt"
                />
              </div>
              <button
                ...
                class="bg-white gymInfoPC-CONTAINER active:scale-[.93] opacity-0 w-full border-[2.4px] tracking-[.2vw] border-[#333] rounded-md py-[2.4vh] uppercase font-[500] text-[1.6vw] px-[2vw] outline-none focus:border-black"
              >
                SUBMIT
              </button>
            </div>
