<template>
  <transition @beforeEnter="handleDetailsDOMEntry('gymRevForm')">
    <div
      v-show="
    ...
    >
      ...
      >
        ...
        <div class="h-max w-full flex flex-col items-start gap-[1.2vh]">
          <span
            class="gymRevForm-HEADING translate-y-[20%] opacity-0 w-full text-start tracking-[-.1vw] font-[400] text-[3.8vh] text-[#333]"
            >{{ userStore.userData.name.split(" ")[0] }}'s Preferences</span
          >
          <button
            @click="scrollToTop"
            class="gymRevForm-HEADING opacity-0 underline underline-offset-[.5vh] translate-y-[20%] text-[2vh] text-[#999] font-[500] w-max flex gap-[.6vw] items-center z"
          >
            Edit Details
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <span>
          <span
            class="mt-[1vh] w-full border-[2px] gymRevForm-HEADING translate-y-[20%] opacity-0 rounded-full px-[4vw] py-[1vh] border-[#666] bg-[#fff7]"
        ...
        <div
          class="gymRevForm-HEADING translate-y-[20%] opacity-0 h-max w-max flex flex-col gap-[1.8vh]"
        >
        ...
        <button
          @click="handleClick"
          class="bg-[#fff9] text-center gymRevForm-HEADING active:scale-[.93] backdrop-blur-[8px] w-[88vw] border-[3.2px] tracking-[.2vw] border-[#333] rounded-md py-[2.4vh] uppercase font-[400] text-[2.4vh] px-[2vw] outline-none focus:border-black"
        >
          CONFIRM
        </button>
      </div>
