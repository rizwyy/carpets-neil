<template>
  ...
  <div class="min-[990px]:hidden h-max w-screen flex justify-center pb-[10vh]">
    ...
    >
      ...
      >
        <span
          class="text-left text-balance gym_Application_Details_Mob-HEADING"
        >
      ...
      <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
        ...
        <div
          :class="[
            'h-[7.2rem]  gym_Application_Details_Mob-CONTAINER overflow-hidden w-full rounded-md border-[2px] border-[#f1f1f1] flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[1.2rem] relative cursor-pointer',
            { selected: userStore.preference.spec_1.includes('Fitness') },
          ]"
          @click="toggleSelect('Fitness')"
        >
          <div
            v-show="userStore.preference.spec_1.includes('Fitness')"
          ...
          <NuxtImg
            ...
            alt=""
          />
          <span class="text-left text-balance">Fitness</span>
        </div>
        ...
        >
          <div
            v-show="userStore.preference.spec_1.includes('Group Training')"
            class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
          >
            <!-- Selected indicator without text -->
            <span
          ...
          <NuxtImg
            ...
            alt=""
          />
          <span class="text-left text-balance">Group Training</span>
        </div>
      </div>
      <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
        <!-- Strength -->
        ...
        >
          <div
            v-show="userStore.preference.spec_1.includes('Strength')"
            class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
          >
            <!-- Selected indicator without text -->
            <span
          ...
          <NuxtImg
            ...
            alt=""
          />
          <span class="text-left text-balance">Strength</span>
        </div>
        ...
        >
          <div
            v-show="userStore.preference.spec_1.includes('Martial Arts')"
            class="selectedDiv h-full w-full from-[20%] absolute bottom-0 left-0 bg-opacity-[.3] z-[1] flex items-start justify-end px-[1vw] py-[1vh]"
          >
            <!-- Selected indicator without text -->
            <span
          ...
          <NuxtImg
            ...
            alt=""
          />
          <span class="text-left text-balance">Martial Arts</span>
        </div>
      </div>
    </div>
  </div>
