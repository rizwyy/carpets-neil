  ...
  >
    ...
    >
      <input
        ...
        class="input_searchBar h-max w-full bg-[#f7f5f2] text-[2vh] font-[400] flex-grow pl-[4vw] outline-none focus:outline-none"
      />
      <div
        @click="onSearch"
        class="flex h-full items-center relative justify-center px-[2.6vw] py-[1.2vh] rounded bg-[#000]"
      >
