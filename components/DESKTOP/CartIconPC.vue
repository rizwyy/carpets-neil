<template>
  <div class="inline-block relative">
    <InvoiceList class="text-[2.2rem]" />
    <!-- Circle Badge -->
    <div
      v-if="userStore.cart.length > 0"
      class="absolute top-[-1.2svh] right-[-.8vw] bg-slate-500 text-[1.6svh] font-[500] text-white flex items-center justify-center rounded-full w-[3svh] h-[3svh]"
    >
