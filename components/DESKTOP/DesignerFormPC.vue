    ...
    >
      ...
      >
        ...
        <div class="h-max w-full flex flex-col gap-[4vh]">
          <div class="h-max w-full flex flex-col gap-[1.2vh] items-start">
            <span>Name</span>
            <input
              :class="{
        ...
        <div class="h-max w-full flex justify-between gap-[3.2vw]">
          ...
          <button
            ...
            :class="[
              ' w-full flex items-center justify-center  border-[#666] active:scale-[.93]  w-full border-[2.4px] tracking-[.2vw] rounded-md py-[2.4vh] uppercase font-[500] text-[1.4vw] px-[2vw] outline-none',
              !formValidated
